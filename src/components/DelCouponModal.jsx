...
function DelCouponModal({data, onClose}) {
  const url = data.url
  console.log(url);
      ...
      <button
        ...
        <>
            ...
            <div className="flex justify-end">
                <button onClick={()=>onClose({isOpen: false})} className="bg-gray-500 hover:bg-gray text-white py-2 px-4 rounded mr-2">Cancel</button>
